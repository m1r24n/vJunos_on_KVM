...
router bgp 4200000011
 ...
 neighbor 10.1.100.0 remote-as 4200000001
 neighbor 10.1.100.0 peer-group underlay
 neighbor 10.1.100.6 remote-as 4200000002
 neighbor 10.1.100.6 peer-group underlay
