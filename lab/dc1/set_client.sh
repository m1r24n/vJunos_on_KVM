#!/bin/bash
export LXC_NAME=client2
export BR=ovs0
export VLAN=203
export ETH0v4=192.168.203.11/24
export ETH0v6=fc00:dead:beef:a203::1000:11/64
export GWv4=192.168.203.254
export GWv6=fc00:dead:beef:a203::1
