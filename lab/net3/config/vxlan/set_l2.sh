...
router bgp 4200000012
 ...
 neighbor 10.1.100.2 remote-as 4200000001
 neighbor 10.1.100.2 peer-group underlay
 neighbor 10.1.100.8 remote-as 4200000002
 neighbor 10.1.100.8 peer-group underlay
