...
## notes
This script is tested on ubuntu 22.04 + KVM + libvirt + python3 on supermicro E200-8d with 128G RAM
...
10. This part is to define the bridge where interface fxp0 (management interface of vJunos is connected to). It can be linux bridge or openvswitch. if it is openvswitch, then vlan ID can be define to put management traffic on different vlan
